...
const menu = [
        ...
        '👉 1. *Reclamos* para reclamar un fallo en un producto o un faltante en su paquete',
        ...
        '👉 6. *Preguntas* para mostrar las preguntas más frecuentes de nuestros clientes',
        '',
        '',
...
const menuFlow = addKeyword(['menu', 'menú', 'hola', 'holis', 'buenas', 'buenos', 'hello'])
